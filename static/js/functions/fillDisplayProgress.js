...
var fillDisplayGoal = function(title, description, startValue, currentValue, created, determinate, completeBy, complete, date_completed, last_updated, endValue, priv, date_created) {
	...
	$("#visual_detailsPage1").append('<p>Start Value: '+startValue+'</p>');
	$("#visual_detailsPage1").append('<p>Current Value: '+currentValue+'</p>');
	$("#visual_detailsPage2").append('<p>Private: '+priv+'</p>');
	...
	if (determinate) {
		$("#visual_detailsPage1").append('<p>End Value: '+endValue+'</p>');
	};
	if (!((completeBy == '')||(completeBy == null))){
		$("#visual_detailsPage1").append('<p>Complete By: '+completeBy+'</p>');
	};
	if (complete) {
...
var fillDisplayUpdate = function(val, description, date, currentValue) {
	$("#visual_detailsPage1").html("");
	$("#visual_detailsPage1").append('<h1>Update on: '+date+'</h1>');
	$("#visual_detailsPage1").append('<p>Value Update: '+val+'</p>');
	$("#visual_detailsPage1").append('<p>Current Value: '+currentValue+'</p>');
	$("#visual_detailsPage1").append('<p>Description: '+description+'</p>');
	$("#visual_details").show();
	$("#vdtabsid").hide();
